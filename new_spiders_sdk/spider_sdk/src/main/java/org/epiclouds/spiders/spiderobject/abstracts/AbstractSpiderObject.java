...
public abstract class AbstractSpiderObject implements SpiderObjectInterface , Delayed{
	...
	private volatile AtomicLong                   finishTime=new AtomicLong(0);
	 ...
	 * 
	 */
	public synchronized SpiderObjectBean toSpiderObjectBean(){
	...
	public synchronized  void storage() throws Exception{
